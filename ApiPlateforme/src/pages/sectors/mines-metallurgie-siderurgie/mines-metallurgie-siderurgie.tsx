    ...
    <div>
      ...
      <div aria-label="Breadcrumbs" className="bg-gray-50 sticky top-24 z-10 flex align-center space-x-2 text-sm font-semibold p-4 lg:p-6 border-spacing-1 overflow-scroll">
        <BreadcrumbsComponent
          breadcrumbs={[
            { name: t("pages_secteurs.mines_metallurgie.fil_ariane.accueil"), path: '/' },
            { name: t("pages_secteurs.mines_metallurgie.fil_ariane.sections"), path: '#' },
            { name: t("pages_secteurs.mines_metallurgie.fil_ariane.pilier"), path: '#' }
          ]}
        />
      </div>
