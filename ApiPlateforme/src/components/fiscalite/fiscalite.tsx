...
import { Calculator, Percent, FileText, ChevronDown, ChevronUp } from 'lucide-react';
...
const FiscalitePage: React.FC = () => {
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-purple-50 to-indigo-100 rounded-3xl">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Fiscalité</h2>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <ul className="text-sm text-blue-700 space-y-2">
                  <li>• CA : 10M à 50M FCFA</li>
                  <li>• Comptabilité allégée OHADA</li>
                  <li>• Option régime réel dès 30M</li>
